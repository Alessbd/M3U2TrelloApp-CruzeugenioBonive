...
const crearTarea = (tarea) => {
  ...
  divTarjeta.innerHTML = `<h5 class="card-title text-card-css">Título: ${tarea.titulo} </h5><h6 class="card-subtitle mb-2">Descripción: ${tarea.detalles}</h6><h6 class="card-subtitle mb-2 text-muted">Responsable: ${tarea.persona}</h6><p class="card-text">Plazo: ${dateFormat(tarea.fechalimite)} </p><p class="card-text">Creación: ${dateFormat(tarea.creado)} </p>`
